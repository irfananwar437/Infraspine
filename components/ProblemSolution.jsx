...
export default function ProblemSolution() {
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-14" style={{ background: '#F8FAFC' }} id="why">
      <div className="max-w-6xl mx-auto px-5 lg:px-8">
        ...
        <Reveal className="lg:hidden mb-8">
          <div className="relative h-[340px] sm:h-[400px] overflow-hidden rounded-2xl border border-slate-200/80 shadow-md">
            <DashboardMockup />
          </div>
        </Reveal>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 lg:items-start">
          <div className="hidden lg:block lg:col-span-5">
            <div className="sticky top-28 h-[min(640px,calc(100vh-7rem))] overflow-hidden rounded-2xl border border-slate-200/80 shadow-lg">
              <DashboardMockup />
            </div>
          </div>
