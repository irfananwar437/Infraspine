...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative isolate flex w-full min-h-[min(100svh,820px)] items-center overflow-hidden pt-[70px]"
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 xl:px-16 py-16 md:py-24">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 max-w-[620px]">
            ...
            {/* Divider */}
            <div className="h-px w-20 mb-6" style={{ background: 'linear-gradient(90deg,#2563EB,#00C853)' }} aria-hidden="true" />
