          ...
          <div className="max-w-3xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
              {[
                ...
                <div key={label} className="rounded-xl p-4 border" style={{ background: 'rgba(255,255,255,0.04)', borderColor: 'rgba(255,255,255,0.08)' }}>
                  <div className="text-[24px] font-black mb-1" style={{ color }}>{value}</div>
